    ...
    picks: [
      {
        ...
        image: { src: "/media/categories/gold/g1.jpg", alt: "Model in a pink lehenga wearing a gold choker", focus: "50% 42%" },
      },
      {
        id: "jhumka-set",
        name: "Haar & Jhumkas",
        ...
        image: { src: "/media/categories/gold/g2.jpg", alt: "Close portrait with a gold necklace and jhumkas", focus: "50% 55%" },
      },
      {
        id: "corridor-haar",
        name: "The Long Haar",
        ...
        image: { src: "/media/categories/gold/g3.jpg", alt: "Gold necklace worn in a sunlit palace corridor", focus: "50% 68%" },
      },
      {
        id: "layered-temple",
        ...
        image: { src: "/media/categories/gold/g4.jpg", alt: "Bride in red with layered temple-gold jewellery", focus: "50% 45%" },
      },
      {
        id: "bridal-suite",
        ...
        image: { src: "/media/categories/gold/g5.jpg", alt: "Seated model in orange with a gold bridal set", focus: "50% 55%" },
      },
      {
        id: "daylight-pair",
        name: "Everyday Gold",
        ...
        image: { src: "/media/categories/gold/g6.jpg", alt: "Gold necklace and earrings in soft daylight", focus: "50% 68%" },
      },
    ],
    ...
    picks: [
      {
        ...
        image: { src: "/media/categories/diamond/d1.jpg", alt: "Soft portrait with a delicate diamond necklace", focus: "50% 55%" },
      },
      {
        id: "statement-pair",
        ...
        image: { src: "/media/categories/diamond/d2.jpg", alt: "Diamond earrings and ring caught in dramatic light", focus: "50% 55%" },
      },
      {
        id: "drop-earrings",
        ...
        image: { src: "/media/categories/diamond/d3.jpg", alt: "Side profile wearing diamond drop earrings", focus: "50% 60%" },
      },
      {
        id: "evening-collar",
        ...
        image: { src: "/media/categories/diamond/d4.jpg", alt: "Model in a green gown with a diamond necklace", focus: "50% 45%" },
      },
      {
        id: "line-necklace",
        ...
        image: { src: "/media/categories/diamond/d5.jpg", alt: "Moody portrait with a diamond line necklace", focus: "50% 55%" },
      },
      {
        id: "solitaire-study",
        ...
        image: { src: "/media/categories/diamond/d6.jpg", alt: "Diamonds catching the light against dark tones", focus: "50% 48%" },
      },
    ],
    ...
    picks: [
      {
        ...
        image: { src: "/media/categories/polki/sapphire-choker.jpg", alt: "Close study of a polki choker with a sapphire drop and matching earrings", focus: "50% 42%" },
      },
      {
        id: "evening-choker",
        ...
        image: { src: "/media/categories/polki/evening-choker.jpg", alt: "Model in royal blue wearing a polki and kundan choker", focus: "50% 55%" },
      },
      {
        id: "midnight-set",
        ...
        image: { src: "/media/categories/polki/midnight-set.jpg", alt: "Model in black wearing a polki choker in low light", focus: "50% 55%" },
      },
      {
        id: "bridal-red",
        ...
        image: { src: "/media/categories/polki/bridal-red.jpg", alt: "Bride in deep red wearing a polki choker and maang tikka", focus: "50% 42%" },
      },
      {
        id: "ivory-suite",
        ...
        image: { src: "/media/categories/polki/ivory-suite.jpg", alt: "Model in ivory wearing a polki necklace strung with pearl", focus: "50% 42%" },
      },
      {
        id: "drop-earrings",
        name: "The Long Drops",
        ...
        image: { src: "/media/categories/polki/drop-earrings.jpg", alt: "Profile study of a long polki drop earring", focus: "56% 50%" },
      },
    ],
